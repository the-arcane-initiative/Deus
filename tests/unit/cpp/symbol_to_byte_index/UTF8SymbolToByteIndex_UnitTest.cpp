...
protected:
    ...
    virtual void SetUp()
    {
        test_data =
        {
            ...
            TestData("this is a مزيج of text", 22, 26),
            TestData("🌿𝄞ꬍꝊޝΟz@", 0, 0),
            TestData("🌿𝄞ꬍꝊޝΟz@", 4, 14),
            TestData("🌿𝄞ꬍꝊޝΟz@", 7, 19),
            TestData("🌿𝄞ꬍꝊޝΟz@", 8, 20),
            ...
            TestData(
                ...
                "बनाइएको छ प्रतीकहरू। यसमा यसको कुनै यूनिकोड प्रतीकहर"
                "ू छैनन्, जुन यसको मतलब छ कि प्रत्येक प्रतीक बिल्कुल ए"
                "क बाइट लायक छ!",
                27,
                69
            ),
...
TEST_F(UTF8SymbolToByteIndexTest, naive)
{
    ...
    {
        std::size_t result = deus::utf8_inl::symbol_to_byte_index_naive(
            data.str.get_view(),
            data.symbol_index
        );
